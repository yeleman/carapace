...
from PyQt5.QtWidgets import QMessageBox, QAction, QMenuBar
...
class MenuBar(QMenuBar, CWidget):
    def __init__(self, parent=None, *args, **kwargs):
        ...
        for m in menu:
            el_menu = QAction(
                QIcon("{}{}.png".format(Constants.img_media, m.get("icon"))),
                m.get("name"),
                self,
            )
        ...
        help_.addAction(
            QIcon("{}info.png".format(Constants.img_media)), "À propos", self.goto_about
        )
